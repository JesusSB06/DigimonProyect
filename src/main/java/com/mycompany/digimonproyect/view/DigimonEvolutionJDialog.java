...
public class DigimonEvolutionJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Next Evolutions", jPanel1);
        ...
        jTabbedPane1.addTab("Prior Evolutions", jPanel2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DigimonEvolutionJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DigimonEvolutionJDialog dialog = new DigimonEvolutionJDialog(new javax.swing.JFrame(), true);
